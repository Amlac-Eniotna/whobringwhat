    ...
    <>
      ...
      <main className="min-h-[calc(100vh-68px)]">
        <section className="m-auto flex h-[calc(100vh-68px)] w-full max-w-3xl flex-col items-center justify-center gap-8 px-4 text-center">
          ...
          </p> <div className="flex max-w-lg items-center gap-3 rounded-lg border border-slate-200 bg-slate-50/50 p-3 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-900/50 dark:text-slate-400">
